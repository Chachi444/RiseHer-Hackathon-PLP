...
const leaders: Leader[] = [
  ...
  },
  {
    ...
    region: 'Kigali',
    photo: '/src/assets/one.jpg',
    bio: 'Charity O. is a community leader working on voter education and local governance projects.',
    expertise: ['Community Engagement', 'Voter Education'],
    contact: { email: 'charity@example.org' },
  },
];
